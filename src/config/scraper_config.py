...
SITE_CONFIGS = [
    ...
    },
    {
        ...
        "label": "CareerViet.vn",
        "enabled": True,
        "base_url": "https://www.careerviet.vn",
        "methods": [METHOD_NEXT_DATA, METHOD_HTML],
        "keywords": ["IT phan mem", "CNTT Phan mem", "CNTT-Phan cung - mang",
                     "lap trinh", "IT", "cong nghe thong tin"],
        "search_url": "/viec-lam/tim-kiem?q={keyword}&page={page}",
        "max_pages": -1,
        "cities": ["Hanoi"],
        "delay": (0.5, 1.0),
        "selectors": {
            "next_data": "#__NEXT_DATA__",
            "html_list": "div.job-item, div[class*='job-card'], article[class*='job'], li[class*='job']",
        },
    },
    {
        "name": "topdev",
